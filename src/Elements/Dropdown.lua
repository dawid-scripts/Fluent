...
function Element:New(Idx, Config)
    ...
    function Dropdown:BuildDropdownList()
        ...
        for Idx, Value in next, Values do
            ...
            Creator.AddSignal(Button.MouseEnter, function() SetBackTransparency(if Selected then 0.85 else 0.89) end)
            Creator.AddSignal(Button.MouseLeave, function() SetBackTransparency(if Selected then 0.89 else 1) end)
            Creator.AddSignal(Button.MouseButton1Down, function() SetBackTransparency(0.92) end)
            Creator.AddSignal(Button.MouseButton1Up, function() SetBackTransparency(if Selected then 0.85 else 0.89) end)
